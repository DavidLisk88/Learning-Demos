...
public class BufferedReadersAndWriters {
    ...
    public static void main(String[] args) {
        ...
        List<BufferedEmployee> employeeList = readAllEmployees(employeeCsvFile);;
    ...
    public static List<BufferedEmployee> readAllEmployees(String filePath) {
        List<BufferedEmployee> employees = new ArrayList<>();
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                employees.add(new BufferedEmployee(id, name, hoursWorked, payRate));
            }
        } catch (IOException e) {
    ...
    public static void displayEmployees(List<BufferedEmployee> employees){
        ...
        for(BufferedEmployee emp : employees){
    ...
    public static void copyNewCsv(List<BufferedEmployee> employees, String filePath){
        try {
    ...
    public static void writeAllEmployees(List<BufferedEmployee> employees, String filePath){
